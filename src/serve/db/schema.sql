...
--
-- ⚠️ PROVISIONAL. Shaped to mirror the Day One JSON export (see src/types.ts),
-- but drafted BEFORE validating against a real export from this account.
-- Reconcile with the first `exports/*.json`, then remove this warning.
--
-- Design rules:
--   * The shape follows the JSON export, the stable contract — not Day One's
--     internal Core Data model, and not whatever a Tier A/C ingester finds easiest.
