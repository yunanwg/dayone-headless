# AGENTS.md — working in dayone-headless
...
- Toolchain: **pnpm** / **bun**, never npm/yarn. English for code, comments,
  commits, PRs.
- Git commits must include a descriptive body, not only a subject. Explain the
  motivation, the material change, and relevant verification in the style of
  the existing project history.
- Commits may keep the `Co-Authored-By: Codex` trailer. PRs/issues: no AI
